...
func createServicePrincipal(displayName, tenantID, subscriptionID string, assignDNSRole bool, resourceGroupName string) (*ServicePrincipalInfo, error) {
...
func generateServicePrincipalTemplate(spInfo *ServicePrincipalInfo, shell string) {
	switch strings.ToLower(shell) {
	case "powershell", "ps1":
		generateServicePrincipalPowerShellTemplate(spInfo)
	case "bash", "sh":
		generateServicePrincipalBashTemplate(spInfo)
	default:
...
func generateServicePrincipalBashTemplate(spInfo *ServicePrincipalInfo) {
	fmt.Println("# Azure SSL Certificate Provisioner - Service Principal Environment Variables")
	fmt.Println("# Generated by create-service-principal command")
	fmt.Println()
	fmt.Println("# ACME account email for Let's Encrypt registration")
	fmt.Println("export ACME_EMAIL=\"your-email@example.com\"")
	fmt.Println()
	fmt.Printf("# Azure subscription and tenant\n")
	...
	fmt.Println()
	fmt.Printf("# Additional service principal information\n")
	fmt.Printf("# Application ID: %s\n", spInfo.ApplicationID)
	fmt.Printf("# Service Principal ID: %s\n", spInfo.ServicePrincipalID)
	fmt.Println()
	fmt.Println("# Usage example:")
	fmt.Println("# ./azure-ssl-certificate-provisioner run -d example.com -e \"$ACME_EMAIL\"")
}

func generateServicePrincipalPowerShellTemplate(spInfo *ServicePrincipalInfo) {
	fmt.Println("# Azure SSL Certificate Provisioner - Service Principal Environment Variables")
	fmt.Println("# Generated by create-service-principal command")
	fmt.Println()
	fmt.Println("# ACME account email for Let's Encrypt registration")
	...
	fmt.Println()
	fmt.Println("# Usage example:")
	fmt.Println("# .\\azure-ssl-certificate-provisioner.exe run -d example.com -e $env:ACME_EMAIL")
}
...
func runCreateServicePrincipal() {
	...
	spInfo, err := createServicePrincipal(displayName, tenantID, subscriptionID, assignRole, resourceGroup)
	if err != nil {
	...
	generateServicePrincipalTemplate(spInfo, shell)
}
